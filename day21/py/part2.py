...
for combo in allcombos:
    ...
    if(battle(player=[100,thissum[1],thissum[2]],boss=[103,9,2])=="Boss"):
        costdict[tuple(combo)]=thissum[0]
    print(thissum)

print(costdict)
print("Final Answer:",list(costdict.keys())[list(costdict.values()).index(max(costdict.values()))],max(costdict.values()))